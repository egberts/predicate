...
This document is the agent protocol for projects using [Predicate](https://github.com/egberts/predicate). It is **required reading** — follow the protocol below before beginning any work.
